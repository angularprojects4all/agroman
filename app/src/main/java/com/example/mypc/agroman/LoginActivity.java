package com.example.mypc.agroman;
...
//            userInfoView = (TextView) findViewById(R.id.textView2);

//            userInfoView.setText(fist_name+" " +last_name);
        }catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//            userInfoView.setText(account.getEmail()+" HELLO "+account.getPhotoUrl());
